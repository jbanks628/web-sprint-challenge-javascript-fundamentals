...
//The nestedFunction() is within the myFunction()'s scope, and the internal variable is declared within the same scope of myFunction().
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(arr){
   ...
   arr.forEach(function(item){
     return animals.push(`name: ${item.animal_name}, scientific: ${item.scientific_name}`)
   });
   return animals;
  }
  ...
  */
  ...
  function lowerCaseNames(zooAnimals){
   let lowercase = zooAnimals.map(function(item){
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals){
    let pops = zooAnimals.filter(function(item){
  ...
  */
  ...
  function USApop(zooAnimals){
    let totalPops = zooAnimals.reduce(function(accumulator, item){
